...
namespace
{
	...
	// ステージ13
	constexpr int kStage13Msec = 58;// ミリ秒
	constexpr int kStage13Second = 8;// 秒
	constexpr int kStage13Minute = 0;// 分
	// ステージ14
	constexpr int kStage14Msec = 47;// ミリ秒
	constexpr int kStage14Second = 7;// 秒
	...
	// ステージ20
	constexpr int kStage20Msec = 27;// ミリ秒
