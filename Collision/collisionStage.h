...
public:
	...
	void collision(bool colR, bool colL, bool colUp, bool colBottom,
		...
		int posY, int posX, 
		const int stage[][kVariable::StageWidth]);			// 全体
	void collisionR(bool colR, 
		const int player[][kVariable::PlayerWidth], int playerWidth,
		int posY, int posX,
		const int stage[][kVariable::StageWidth]);			// 右

	void collisionL(bool colL,
		const int player[][kVariable::PlayerWidth], int playerWidth,
		int posY, int posX,
		const int stage[][kVariable::StageWidth]);			// 左

	void collisionUP(bool colUp,
		const int player[][kVariable::PlayerWidth], int playerWidth,
		int posY, int posX,
		const int stage[][kVariable::StageWidth]);			// 上

	void collisionBottom(bool colBottom,
		const int player[][kVariable::PlayerWidth], int playerWidth,
		int posY, int posX,
		const int stage[][kVariable::StageWidth]);		// 下
private:
